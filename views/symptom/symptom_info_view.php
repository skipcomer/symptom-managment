<!-- BEGIN include symptom_info_view.php -->
      <br/>  
      <div class="container">  
		<!-- *************** START DOCUMENT CONTENT HERE *************** -->
		<div class="row">
			<div id="symptom-heading" class="col-xs-12">
                <h3><?php echo $screen_info_array[0]["s_name"]; ?>: Basic Information</h3>
			</div>  <!-- /#symptom_heading  -->
        </div> <!--/.row -->    
        <div id="symptomtext"><?php
		
foreach($symptom_info_array["paragraphs"] as $paragraph){
	echo '
			<div class="row">
...
?>	
	...
	foreach($symptom_info_submenu_array as $ui){
					 echo '				
...
<!-- END include inc/portal_symptom_viewer.php -->
